    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-primary-500/5 to-background px-4 py-12">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          {expired && (
            <div className="mt-3 px-4 py-2.5 rounded-xl bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 text-xs text-amber-700 dark:text-amber-300">
